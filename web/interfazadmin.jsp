	...
	<script src="js/main.js" ></script>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
             ...
             Materialize.toast('Su clave se actualizo correctamennte &nbsp;&nbsp;<a href="interfazadmin.jsp">OK</a>',9000, 'rounded');
        ...
        <script type="text/javascript">
            $(document).ready(function(){          
             Materialize.toast('Bienvenido un gusto Tenerlo por acá de nuevo &nbsp;&nbsp;<a href="interfazadmin.jsp">OK</a>',9000, 'rounded');   
            });
		...
		<div class="row">
			...
			<ul class="NavBar-links col m9">
				<li><a href="interfazadmin.jsp" class="waves-effect">Home</a></li>
                                <li><a href="reporte.jsp" class="waves-effect">Reporte</a></li>
                                <li><a href="AdministrarTarifario.jsp" class="waves-effect">Administrar servicios</a></li>
                                <li><a href="validarmembrecias.jsp" class="waves-effect">Validar membresias</a></li>
                                <li><a href="usuariosOperador.jsp" class="waves-effect">Administrar usuarios</a></li>
...
<!--- banner y mismion-->
	...
	<section class="full new-prod">
		<h5 class="tittles center-align">Interfaz Administrador</h5>
		<div class="container">
			<div class="row">
