<%-- 
    Document   : pedidos
    Created on : 25/10/2017, 03:41:26 PM
    Author     : user
--%>
...
<html>
	...
	<script src="js/main.js" ></script>
        ...
        <link href="css/materialize.clockpicker.css" rel="stylesheet" type="text/css"/>
    ...
    aftershow: function(){} //Function for after opening timepicker
        ...
        <script type="text/javascript">
            $(document).ready(function(){
             ...
             Materialize.toast('La operación fue realizada con exito &nbsp;&nbsp;<a href="pedidos.jsp">OK</a>',9000, 'rounded');
	...
	<nav class="NavBar full">
		<div class="row">
			...
			<ul class="NavBar-links col m9">
				...
				<li><a href="tarifario.jsp" class="waves-effect">Tarifario</a></li>
	     ...
	     <h5 class="tittles center-align">Pedidos solicitados</h5>
		<div class="container valign">
			<div class="row">
                              ...
                              <%   
                                  ...
                                  try{
                                    idoperador=(Integer)session.getAttribute("idusuario");
                                    idsucursal=(Integer)session.getAttribute("idsucursal");
                                     } catch(Exception e){
                                   response.sendRedirect(request.getContextPath()+"/home?errorsesion=errorsesion");
                              }
                                    ...
                                    ArrayList<Factura> datos=fac.getFacturaestadoenviadoarecojer(idsucursal);/// consulta bd 
               ...
               %>
                           ...
                           <table class="responsive-table">
                                ...
                                <tbody>
                                    ...
                                    <td><%=estado%></td>
                                    <td>
                                         <form action="detalledepedidos.jsp" method="post">
                                            <input name="nofactura" type="hidden" value="<%=nofactura%>"/>
                                            <button  type="submit" class="tooltipped" data-position="right" data-tooltip="Detallar"><i class="small material-icons">local_laundry_service</button> 
                                         </form>
