...
<html>
	...
	<script src="js/main.js" ></script>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
             ...
             Materialize.toast('La operación fue realizada con exito &nbsp;&nbsp;<a href="reparto.jsp">OK</a>',9000, 'rounded');
	...
	<h5 class="center-align tittles">Solicitudes para reparto</h5>
		<div class="container valign">
			<div class="row">
                              ...
                              <%   
                                    ...
                                    ArrayList<Factura> datos=fac.getFacturaesnofactestadoprocesado(idsucursal);/// consulta bd 
                           ...
                           <table class="responsive-table light-blue lighten-5">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        ...
                                        <form action="detallereparto.jsp" method="post">
