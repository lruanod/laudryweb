...
<html>
	...
	<h5 class="tittles center-align">crear plan de membresía</h5>
		<div class="container valign">
			<div class="row">
                                     ...
                                     <form method="post" action="xyzinsertmembrecia">
                                       
                                          <a class="waves-effect waves-light btn blue">nombre del plan</a></br>
                                          <div class="input-field col s12">
                                            
					<i class="zmdi zmdi-movie prefix"></i>
                                        <input id="nombre" type="text" class="validate" name="nombre" pattern="[A-Z,a-z,áéíóú,ÁÉÍÓÚ, ,Ññ,0-9]{4,100}"  title="Ingresar letras y numeros sin símbolos especiales" required="">
					...
					<i class="zmdi zmdi-money prefix"></i>
                                        <input id="cuota" type="number" class="validate" name="cuota" required="" >
					...
					<i class="zmdi zmdi-money prefix"></i>
                                        <input id="saldo" type="number" class="validate" name="saldo" required="" >
