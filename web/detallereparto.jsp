	...
	<nav class="NavBar full">
		<div class="row">
			...
			<i class="zmdi zmdi-more-vert full btn-menu hide-on-med-and-up waves-effect"></i>
	         ...
	         <h5 class="center-align tittles">Imprimir y validar orden  de Reparto</h5>
		<div class="container valign">
			<div class="row">
                              ...
                              <%    
                                    ...
                                    ArrayList<Factura> datos=fac.getFacturapornumeroestadoprocesado(nofactura2);/// consulta bd 
...
for(Factura fact : list) {
                           ...
                           <table class="responsive-table light-blue lighten-5">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                             ...
                                             <form action="xyzImprimirFactura" method="post" target="_blank">
    ...
    <form id="ordenoperador" class="modal modal-fixed-footer" method="post" action="xyzinsertOrdenRepartidorEstadoenviado">
