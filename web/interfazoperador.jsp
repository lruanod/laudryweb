	...
	<script src="js/main.js" ></script>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
             ...
             Materialize.toast('Su clave se actualizo correctamennte &nbsp;&nbsp;<a href="interfazoperador.jsp">OK</a>',9000, 'rounded');
        ...
        <script type="text/javascript">
            $(document).ready(function(){          
             Materialize.toast('Bienvenido un gusto Tenerlo por acá de nuevo &nbsp;&nbsp;<a href="interfazoperador.jsp">OK</a>',9000, 'rounded');   
            });
...
<!--- banner y mismion-->
	...
	<section class="full new-prod">
		<h5 class="tittles center-align">Interfaz operador</h5>
		<div class="container">
			<div class="row">
