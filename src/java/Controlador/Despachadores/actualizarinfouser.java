 ...
 * @author user
 */
public class actualizarinfouser extends HttpServlet {
///xyzactualizarinfouser
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession sesion = request.getSession(true);//// recuperando la sesion 
         ...
         String direccioncasa =request.getParameter("descripcion_casa");
    ...
    int idmunicipio=Integer.parseInt(request.getParameter("idmunicipio"));
        ...
        us.updateUsuarioinfo(idusuario, direccion, direccioncasa, tel, cel, idmunicipio);
        
      
         response.sendRedirect(request.getContextPath()+"/home?exito2='exito'");
