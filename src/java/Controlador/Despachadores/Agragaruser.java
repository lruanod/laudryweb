 ...
 * @author user
 */
public class Agragaruser extends HttpServlet {
//agragaruser
    /**
        ...
        for(Usuario usu : list2) { 
            ...
            idusuario=usu.getIdusuario();
                 ...
                 String messageEnter = "Bienvenido Nuevo usuario =). Para validar su correo, haga click aquí en validar: </br> "
                         + "<form  action=\"http://localhost:8080/Laudry-hibernate_2/valuzxzy\"  method=\"POST\">\n" +
"            \n" +
...
"        ";
                ...
                response.sendRedirect(request.getContextPath()+"/home?novalido="+novalido+"");  
                status = false;
            }
         ...
         if (status == true) {
             ...
             response.sendRedirect(request.getContextPath()+"/home?exito="+cuentaexito+"");  
            }
            ...
            response.sendRedirect(request.getContextPath()+"/home?repetido="+repetido+"");
