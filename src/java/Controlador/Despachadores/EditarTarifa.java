 ...
 * @author user
 */
public class EditarTarifa extends HttpServlet {
//xyzEditarTarifa
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setCharacterEncoding("UTF-8");
         ...
         String nombre=request.getParameter("Serviciolavado");
         String tarifa=request.getParameter("tarifa");
         BigDecimal tarifa2=new BigDecimal(tarifa);
         
         
         ServiciosCRUD ser=new ServiciosCRUD();
         TarifaCRUD tari= new TarifaCRUD();
         
         tari.updateTarifa(idtarifa, nombre, tarifa2);
         ser.updateservicio(idservicio, descripcion, url, estado, idcategoria);
