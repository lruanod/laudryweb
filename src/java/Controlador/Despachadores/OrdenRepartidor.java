 ...
 * @author user
 */
public class OrdenRepartidor extends HttpServlet {
      //xyzOrdenRepartidor
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
          ...
          String entrega="ENVIADO A RECOGER";
          String estado="ENVIADO A RECOGER";
       ...
       Usuario usuario=user.getUsuarioPorIdunion(idusuario);
          ...
          fact.updatefacturaestado(nofactura, estado);
             ...
             response.sendRedirect(request.getContextPath()+"/solicitudes.jsp?exito='exito'");
