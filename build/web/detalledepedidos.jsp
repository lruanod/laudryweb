...
for(Factura fact : list) {
               ...
               %>
                           ...
                           <table class="responsive-table">
                                ...
                                <tbody>
                                    ...
                                    <td><%=estado%></td>
                                    <td>
                                        <a href="#ordenoperador" class="modal-trigger"> <button  type="button" class="tooltipped" data-position="right" data-tooltip="Determinar Tiempo"><i class="small material-icons">alarm</button> </a>
                                    </td>
    ...
    <form id="ordenoperador" class="modal modal-fixed-footer" method="post" action="xyzInsertOrdenoperador">
		<div class="modal-content">
			<h5 class="center-align">Recargos y estimación de tiempo </h5>
			<div class="row">
                                ...
                                <div class="input-field col s12">
                                    ...
                                    <i class="zmdi zmdi-alarm prefix"></i>
                                    <input  id="tiempo"  name="tiempo" type="text" class="timepicker" required="">  
                                ...
                                <div class="input-field col s12">
                                    ...
                                    <input type="number" step='0.01' value='0.00' placeholder='0.00' name="recargo" id="recargo" required=""/>
