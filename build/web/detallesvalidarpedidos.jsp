...
<html>
	...
	<h5 class="center-align tittles">Detalle orden entregadas</h5>
...
for(Factura fact : list) {
    ...
    <form id="ordenoperador" class="modal modal-fixed-footer" method="post" action="xyzInsertOrdenadmin">
		<div class="modal-content">
			<h5 class="center-align">Enviar a Despacho</h5>
			<div class="row">
		...
		<div class="modal-footer">
                        ...
                        <button  id="boton2" type="submit"  class="waves-effect btn-flat tooltipped" data-position="top" data-tooltip="Autorizar"><i class="zmdi zmdi-check"></i> </button>
